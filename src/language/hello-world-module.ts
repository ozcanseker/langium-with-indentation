...
import { HelloWorldLexer, HelloWorldTokenBuilder } from './hello-world-tokengenerator';
...
export const HelloWorldModule: Module<HelloWorldServices, PartialLangiumServices & HelloWorldAddedServices> = {
    ...
    parser : {
        TokenBuilder: () => new HelloWorldTokenBuilder(),
        Lexer: (services) => new HelloWorldLexer(services)
    }
};
